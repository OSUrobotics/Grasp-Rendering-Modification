...
void main(){
        ...
        // Vector from the vertex to the light, in camera space. M is ommitted because it's identity.
        vec3 LightPosition_cameraspace = ( V * vec4(LightPosition_worldspace,1)).xyz;
        //vec3 LightPosition_cameraspace = vec4(1,1,1,0).xyz; //vec4(LightPosition_worldspace,1).xyz;
